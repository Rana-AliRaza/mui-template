import { Avatar, AvatarGroup, Box, ImageList, Typography,ImageListItem, Divider, List , ListItem, ListItemAvatar, ListItemText } from '@mui/material'
  ...
  return (
    ...
    >
      <Box position="fixed" width="25%">
        ...
        <Typography sx={{fontWeight: "100"}} variant="h6">Online Friends </Typography>
        <AvatarGroup max={7}>
        ...
        <Typography sx={{fontWeight: "100"}} variant="h6" mt={2} mb={2}>Latest Photos </Typography>
        ...
        <Typography sx={{fontWeight: "100"}} variant="h6" mt={2} mb={2}>Latest Conversation </Typography>
        <List>
